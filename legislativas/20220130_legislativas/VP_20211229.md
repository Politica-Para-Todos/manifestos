...
- **Rever e aumentar os incentivo**s para a fixação de profissionais em zonas mais carenciadas.
...
Outro tema importante no aspecto da regulação é o reforço da i**ndependência das entidades reguladoras**. Não basta legislar para obter os resultados pretendidos. É necessário garantir que a fiscalização e aplicação das leis seja levada a cabo de forma imparcial e transparente. Nesse sentido o Volt considera importante:
...
- **Adoção de medidas específicas de apoio aos agricultore**s face à existência de crises, incluindo em alguns casos a manutenção dos preços.
